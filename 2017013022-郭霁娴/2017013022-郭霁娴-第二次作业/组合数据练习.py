#tuple类型练习
print("tuple类型练习：")
str = ("2017013022","guojx","115199116056",20)
print(str)
...
print("set类型练习：")
set1 = {'a', 'z', 'b', 4, 6, 1}
set2 = { "2017013022","guojx","15199116056",6,"2017013022","guojx"}
set3 = {'a', 'z', 'b',2,0}
set1.add(8)
set2.add('lisy')
...
#dict类型练习
print("dict类型练习：")
dic1 = {2017013022:[1,2,3]}
dic2 = {2017010052:[4,5,6]}
dic1.update(b=[2.3])
print(dic1)
